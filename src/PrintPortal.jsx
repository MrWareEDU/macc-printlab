        ...
        <div>
          ...
          <div ref={lfileDropRef}
            ...
            {laserFile?<div style={{ width:"100%", textAlign:"left" }}>
              ...
              {admin&&!sbConnected&&<div style={{ display:"flex", alignItems:"center", gap:8, background:"rgba(245,158,11,0.08)", border:"1px solid rgba(245,158,11,0.2)", borderRadius:6, padding:"4px 10px" }}>
          <div style={{ width:6, height:6, borderRadius:"50%", background:"#f59e0b", flexShrink:0 }}/>
          <div style={{ fontSize:10, color:"#f59e0b" }}>Local only</div>
          <button onClick={function(){setShowSBSettings(true);}} style={{ background:"none", border:"none", color:"#fbbf24", cursor:"pointer", fontSize:10, textDecoration:"underline", padding:0 }}>Connect</button>
        </div>}
        {admin&&sbConnected&&<div style={{ display:"flex", alignItems:"center", gap:6, background:"rgba(34,197,94,0.07)", border:"1px solid rgba(34,197,94,0.2)", borderRadius:6, padding:"4px 10px" }}>
          <div style={{ width:6, height:6, borderRadius:"50%", background:"#22c55e", flexShrink:0 }}/>
          <div style={{ fontSize:10, color:"#4ade80" }}>Shared queue</div>
        </div>}
    ...
    <nav style={{ borderBottom:"1px solid #0d1220", background:"rgba(15,23,42,0.98)", backdropFilter:"blur(10px)", position:"sticky", top:0, zIndex:100 }}>
      <div style={{ maxWidth:1300, margin:"0 auto", padding:"0 16px", display:"flex", alignItems:"center", justifyContent:"space-between", height:56, gap:8 }}>
        ...
        :<div style={{ display:"flex", alignItems:"center", gap:5, overflow:"auto" }}>
          ...
          {admin&&<div style={{ display:"flex", alignItems:"center", gap:6, background:"#1e293b", border:"1px solid #111827", borderRadius:8, padding:"4px 8px 4px 5px", marginLeft:4 }}>
